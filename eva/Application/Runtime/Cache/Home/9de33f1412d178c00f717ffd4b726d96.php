...
<div style=" text-align:center;"><font size="3px">供应商对账单</font></div>
<br /><br />
供应商:&nbsp;<?php echo ($sname); ?>&nbsp;&nbsp;&nbsp;&nbsp;<br />
...
<td style="padding-left:0px" width="35%" align="center">总价</td>
 ...
 <?php if(is_array($plist)): $i = 0; $__LIST__ = $plist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo["cf"] == 1 and $vo["sum"] < 0): else: ?>
          <tr>
