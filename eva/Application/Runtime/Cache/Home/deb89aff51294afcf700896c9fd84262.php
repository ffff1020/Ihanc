...
$(document).ready(function(){
 ...
 $('#income_form').ajaxForm({
		beforeSubmit: function(){
			var sum=$('#income_form input[name="sum"]').val();
			if(sum==''){
				alert("请输入产生收入金额!");
				return false;
			}
			if(isNaN(sum)){
				alert("请在收入金额中输入正确的数字!");
				$('#income_form input[name="sum"]').val('');
				return false;
			}
		},
		async: true,
	    ...
	    dataType: 'json'
                ...
                <div class="container_12 clearfix leading">
                    <div class="grid_12">
                    	<form class="form has-validation" id="income_form" action="/ihanc/eva/index.php/Home/Finance/incomeAdd" method="post">
                           <div class="clearfix">
