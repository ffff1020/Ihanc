...
$(document).ready(function(){
   $.get("/ihanc/eva/index.php/Home/Sale/saleTable", function(result){
...
function check(){
	...
	if(idmember) return true;
	alert("请输入客户,或者输入开始日期和结束日期!");
	return false;
}
</script>
<h1 class="page-title">历史销售单</h1>
<div class="container_12 clearfix leading">
<div class="grid_12">
<form class="form" action="/ihanc/eva/index.php/Home/Sale/saleTable" id="sale_list_form" method="post" onkeydown="if(event.keyCode==13){return false;}">
 <div class="clearfix">
                            ...
                            <div class="clearfix">
                                ...
                                <div class="form-input"><input type="text" name="mname"   onkeyup='getmember(this)' onkeydown='selectmember(this)' /></div>
