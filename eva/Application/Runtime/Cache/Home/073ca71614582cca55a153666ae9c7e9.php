...
function checkprint(){
		...
		if(idsupply=='') {alert("请输入供应商!");return ;}
		window.open("/ihanc/eva/index.php/Home/Purchase/checkPrint/sname/"+$('#purchase_list_form input[name="sname"]').val()+"/idsupply/"+idsupply+"/edate/"+edate+"/sdate/"+sdate);
}
</script>
<h1 class="page-title">供应商对账单</h1>
<div class="container_12 clearfix leading">
<div class="grid_12">
<form class="form" action="/ihanc/eva/index.php/Home/Purchase/purchaseCheck" id="purchase_list_form" method="post" onkeydown="if(event.keyCode==13){return false;}">
 <div class="clearfix">
                            ...
                            <div class="clearfix">
                                ...
                                <label for="form-birthday" class="form-label">供应商<em>*</em></label>
                            ...
                            <div class="form-action clearfix">
                                ...
                                <button class="button" type="submit">查询</button>
								 <a class="button" onclick="checkprint()" >打印</a>
