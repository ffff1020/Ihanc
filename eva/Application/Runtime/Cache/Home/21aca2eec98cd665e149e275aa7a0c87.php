...
<td  width="35%" align="center">总价</td>
 ...
 <?php if($vo["cf"] == 1 and $vo["sum"] < 0): else: ?>
 <tr>
...
<tr><td colspan='5'>备注:<?php echo ($vo["remark"]); ?></td></tr><?php endif; endif; ?>
...
<?php if($credit == 0): ?><tr><td colspan='5'>累计应收：￥<?php echo (number_format($credit)); ?></tr><?php endif; ?>
</table>
<div>
<br/>
客户签名：<br/><br/>
