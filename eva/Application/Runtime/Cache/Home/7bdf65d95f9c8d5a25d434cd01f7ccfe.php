...
<td  width="35%" align="center">总价</td>
 ...
 <?php if($vo["sum"] < 0 ): if($vo["idgoods"] != null): ?><tr>
...
<td style="padding-left:0px"  align="center"></td>
<td style="padding-left:0px"  align="center"></td>
<td style="padding-left:0px"  align="center">￥<?php echo (number_format($vo["sum"])); ?></td>
</tr><?php endif; ?>
 <?php else: ?>
 <tr>
 <td style="padding-left:0px;font-size:14px"  align="left"><?php echo (substr($vo["time"],5,5)); ?></td>
...
<td style="padding-left:0px"  align="center"><?php echo (number_format($vo["price"],1)); ?></td>
...
<?php if($vo["remark"] != null): ?><tr><td colspan='5'>备注:<?php echo ($vo["remark"]); ?></td></tr><?php endif; endif; ?>
...
<div style=" text-align:center;"><font size="4px"><b><?php echo ($info["info_name"]); ?></b></font></div>
<div style=" text-align:center;"><font size="3px">
<?php if(empty($_GET['sdate'])): echo date('Y-m');?>
<?php else: ?> 
<?php echo (substr($_GET['sdate'],5,5)); ?>到<?php echo (substr($_GET['edate'],5,5)); endif; ?> 
客户对账单</font></div>
<br />
...
<tr><td colspan='3'>合计数量：<?php echo ($ttl_num); ?></td><td colspan='2'>合计货款：￥<?php echo (number_format($ttl_sum)); ?></td></tr>
<tr><td colspan='5'>合计付款：￥<?php echo (number_format($ttl_paid)); ?></td></tr>
</table>
<div>
<br/>
客户签名：<br/><br/>
